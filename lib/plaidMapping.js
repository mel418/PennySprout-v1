...
export function mapPfcToCategory(pfc, description = '', transactionCode = null) {
...
export function plaidTxnToRow(txn, { userId, itemRowId }) {
  ...
  return {
    ...
    category: mapPfcToCategory(txn.personal_finance_category, rawDescription, txn.transaction_code),
