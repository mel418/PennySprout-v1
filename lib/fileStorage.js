...
// Looks up an existing file by content hash (a fingerprint of its
// transaction data — see lib/transactionHash.js), scoped to the user, so
// the upload route can warn before creating a duplicate. Returns just
// enough to show a "you already uploaded this" message — not the full row.
